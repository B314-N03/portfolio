...
function Impressum(): JSX.Element {
  ...
  return (
    <div className='content text-color-main z-index-1'>
        ...
        <Breadcrumb name="Impressum"/>
        <p className="h1">Impressum</p>
        <div className="w-75">

        <p className="h2">Informationen über den Diensteanbieter</p>
        <p><strong>Béla Noé</strong><br/>
            Deutschland<br/>
            E-Mail: bela-noe@web.de
        </p>

        <p><strong className="h3 underline">EU-Streitschlichtung</strong></p>

        <p>Gemäß Verordnung über Online-Streitbeilegung in Verbraucherangelegenheiten (ODR-Verordnung) möchten wir Sie über die Online-Streitbeilegungsplattform (OS-Plattform) informieren. Verbraucher haben die Möglichkeit, Beschwerden an die Online Streitbeilegungsplattform der Europäischen Kommission unter <a href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&lng=DE">https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&lng=DE</a> zu richten. Die dafür notwendigen Kontaktdaten finden Sie oberhalb in unserem Impressum.</p>

        <p>Wir möchten Sie jedoch darauf hinweisen, dass wir nicht bereit oder verpflichtet sind, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</p>

        <p className="h3">Haftung für Inhalte dieser Website</p>
        ...
        <p className="h3">Haftung für Links auf dieser Website</p>
        ...
        <p className="h3">Urheberrechtshinweis</p>
        ...
        <p className="h5">Anwendungsbereich</p>
        ...
        <p className="h5">Rechtsgrundlagen</p>
        ...
        <p>Weitere Bedingungen wie die Wahrnehmung von Aufnahmen im öffentlichen Interesse und Ausübung öffentlicher Gewalt sowie der Schutz lebenswichtiger Interessen treten bei uns in der Regel nicht auf. Soweit eine solche Rechtsgrundlage doch einschlägig sein sollte, wird diese an der entsprechenden Stelle ausgewiesen.</p>

        <p className="h5">Kontaktdaten des Verantwortlichen</p>

        <p>Wenn Sie Fragen zum Datenschutz oder zur Verarbeitung personenbezogener Daten haben, finden Sie nachfolgend die Kontaktdaten der verantwortlichen Person bzw. Stelle:</p>

        <p><strong>Béla Noé</strong><br/>
            Deutschland<br/>
            E-Mail: <a href="mailto:bela-noe@web.de">bela-noe@web.de</a><br/>
            Telefon: 0177/2336345
        </p>

        <p><strong>Speicherdauer</strong></p>

        <p>Dass wir personenbezogene Daten nur so lange speichern, wie es für die Bereitstellung unserer Dienstleistungen und Produkte unbedingt notwendig ist, gilt als generelles Kriterium bei uns. Dies bedeutet, dass wir personenbezogene Daten löschen, sobald der Grund für die Datenverarbeitung nicht mehr vorhanden ist. In einigen Fällen sind wir gesetzlich dazu verpflichtet, bestimmte Daten auch nach Wegfall des ursprünglichen Zwecks zu speichern, zum Beispiel für buchhalterische Zwecke.</p>

        <p>Wenn Sie die Löschung Ihrer Daten wünschen oder die Einwilligung zur Datenverarbeitung widerrufen, werden die Daten so schnell wie möglich und soweit keine Pflicht zur Speicherung besteht, gelöscht.</p>

        <p>Über die spezifische Dauer der jeweiligen Datenverarbeitung informieren wir Sie weiter unten, sofern wir weitere Informationen dazu haben.</p>
        
        <p className="h2">Rechte laut Datenschutz-Grundverordnung</p>
...
<ul>
    <li>
        <strong>Sie haben laut Artikel 15 DSGVO ein Auskunftsrecht</strong> darüber, ob wir Daten von Ihnen verarbeiten. Sollte das zutreffen, haben Sie Recht darauf eine Kopie der Daten zu erhalten und die folgenden Informationen zu erfahren:
        <ul>
    ...
    <li>
        <strong>Sie haben laut Artikel 16 DSGVO ein Recht auf Berichtigung</strong> der Daten, was bedeutet, dass wir Daten richtig stellen müssen, falls Sie Fehler finden.
    </li>
    <li>
        <strong>Sie haben laut Artikel 17 DSGVO das Recht auf Löschung („Recht auf Vergessenwerden“)</strong>, was konkret bedeutet, dass Sie die Löschung Ihrer Daten verlangen dürfen.
    </li>
    <li>
        <strong>Sie haben laut Artikel 18 DSGVO das Recht auf Einschränkung der Verarbeitung</strong>, was bedeutet, dass wir die Daten nur mehr speichern dürfen aber nicht weiter verwenden.
    </li>
    <li>
        <strong>Sie haben laut Artikel 20 DSGVO das Recht auf Datenübertragbarkeit</strong>, was bedeutet, dass wir Ihnen auf Anfrage Ihre Daten in einem gängigen Format zur Verfügung stellen.
    </li>
    <li>
        <strong>Sie haben laut Artikel 21 DSGVO ein Widerspruchsrecht</strong>, welches nach Durchsetzung eine Änderung der Verarbeitung mit sich bringt.
        <ul>
    ...
    <li>
        <strong>Sie haben laut Artikel 22 DSGVO unter Umständen das Recht</strong>, nicht einer ausschließlich auf einer automatisierten Verarbeitung (zum Beispiel Profiling) beruhenden Entscheidung unterworfen zu werden.
    </li>
    <li>
        <strong>Sie haben laut Artikel 77 DSGVO das Recht auf Beschwerde</strong>. Das heißt, Sie können sich jederzeit bei der Datenschutzbehörde beschweren, wenn Sie der Meinung sind, dass die Datenverarbeitung von personenbezogenen Daten gegen die DSGVO verstößt.
    </li>
</ul>
...
<p><strong>Nordrhein-Westfalen Datenschutzbehörde</strong><br/>
...
<p className="h2">Cookies</p>

<p className="h3">Zusammenfassung</p>
<ul>
    <li><strong>👥 Betroffene:</strong> Besucher der Website</li>
    <li><strong>🤝 Zweck:</strong> abhängig vom jeweiligen Cookie. Mehr Details dazu finden Sie weiter unten bzw. beim Hersteller der Software, die das Cookie setzt.</li>
    <li><strong>📓 Verarbeitete Daten:</strong> Abhängig vom jeweils eingesetzten Cookie. Mehr Details dazu finden Sie weiter unten bzw. beim Hersteller der Software, die das Cookie setzt.</li>
    <li><strong>📅 Speicherdauer:</strong> abhängig vom jeweiligen Cookie, kann von Stunden bis hin zu Jahren variieren</li>
    <li><strong>⚖️ Rechtsgrundlagen:</strong> Art. 6 Abs. 1 lit. a DSGVO (Einwilligung), Art. 6 Abs. 1 lit. f DSGVO (Berechtigte Interessen)</li>
</ul>

<p className="h3">Was sind Cookies?</p>
...
<p className="h3">HTTP Cookie Interaktion zwischen Browser und Webserver</p>
...
<strong>Wert:</strong> GA1.2.1326744211.152322858805-9<br/>
...
<p className="h3">Welche Arten von Cookies gibt es?</p>

<p>Die Frage welche Cookies wir im Speziellen verwenden, hängt von den verwendeten Diensten ab und wird in den folgenden Abschnitten der Datenschutzerklärung geklärt. An dieser Stelle möchten wir kurz auf die verschiedenen Arten von HTTP-Cookies eingehen.</p>

<p>Man kann 4 Arten von Cookies unterscheiden:</p>
<ul>
    <li><strong>Unerlässliche Cookies:</strong> Diese Cookies sind nötig, um grundlegende Funktionen der Website sicherzustellen. Zum Beispiel braucht es diese Cookies, wenn ein User ein Produkt in den Warenkorb legt, dann auf anderen Seiten weitersurft und später erst zur Kasse geht. Durch diese Cookies wird der Warenkorb nicht gelöscht, selbst wenn der User sein Browserfenster schließt.</li>
    <li><strong>Zweckmäßige Cookies:</strong> Diese Cookies sammeln Infos über das Userverhalten und ob der User etwaige Fehlermeldungen bekommt. Zudem werden mithilfe dieser Cookies auch die Ladezeit und das Verhalten der Website bei verschiedenen Browsern gemessen.</li>
    <li><strong>Zielorientierte Cookies:</strong> Diese Cookies sorgen für eine bessere Nutzerfreundlichkeit. Beispielsweise werden eingegebene Standorte, Schriftgrößen oder Formulardaten gespeichert.</li>
    <li><strong>Werbe-Cookies:</strong> Diese Cookies werden auch Targeting-Cookies genannt. Sie dienen dazu dem User individuell angepasste Werbung zu liefern. Das kann sehr praktisch, aber auch sehr nervig sein.</li>
</ul>
...
<p className="h3">Zweck der Verarbeitung über Cookies</p>
...
<p className="h3">Welche Daten werden verarbeitet?</p>
...
<p className="h3">Speicherdauer von Cookies</p>
<p>Die Speicherdauer hängt vom jeweiligen Cookie ab und wird weiter unter präzisiert. Manche Cookies werden nach weniger als einer Stunde gelöscht, andere können mehrere Jahre auf einem Computer gespeichert bleiben.</p>

<p>Sie haben außerdem selbst Einfluss auf die Speicherdauer. Sie können über ihren Browser sämtliche Cookies jederzeit manuell löschen (siehe auch unten “Widerspruchsrecht”). Ferner werden Cookies, die auf einer Einwilligung beruhen, spätestens nach Widerruf Ihrer Einwilligung gelöscht, wobei die Rechtmäßigkeit der Speicherung bis dahin unberührt bleibt.</p>

<p className="h3">Widerspruchsrecht – wie kann ich Cookies löschen?</p>
<p>Wie und ob Sie Cookies verwenden wollen, entscheiden Sie selbst. Unabhängig von welchem Service oder welcher Website die Cookies stammen, haben Sie immer die Möglichkeit Cookies zu löschen, zu deaktivieren oder nur teilweise zuzulassen. Zum Beispiel können Sie Cookies von Drittanbietern blockieren, aber alle anderen Cookies zulassen.</p>

<p>Wenn Sie feststellen möchten, welche Cookies in Ihrem Browser gespeichert wurden, wenn Sie Cookie-Einstellungen ändern oder löschen wollen, können Sie dies in Ihren Browser-Einstellungen finden:</p>

<ul>
    <li><a href="https://support.google.com/chrome/answer/95647">Chrome: Cookies in Chrome löschen, aktivieren und verwalten</a></li>
    <li><a href="https://support.apple.com/kb/PH21411?locale=de_DE">Safari: Verwalten von Cookies und Websitedaten mit Safari</a></li>
    <li><a href="https://support.mozilla.org/de/kb/cookies-auffinden-und-loeschen">Firefox: Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a></li>
    <li><a href="https://support.microsoft.com/de-de/help/278835/how-to-delete-cookies">Internet Explorer: Löschen und Verwalten von Cookies</a></li>
    <li><a href="https://support.microsoft.com/de-de/help/4027947/windows-delete-cookies">Microsoft Edge: Löschen und Verwalten von Cookies</a></li>
</ul>

<p>Falls Sie grundsätzlich keine Cookies haben wollen, können Sie Ihren Browser so einrichten, dass er Sie immer informiert, wenn ein Cookie gesetzt werden soll. So können Sie bei jedem einzelnen Cookie entscheiden, ob Sie das Cookie erlauben oder nicht. Die Vorgangsweise ist je nach Browser verschieden. Am besten Sie suchen die Anleitung in Google mit dem Suchbegriff “Cookies löschen Chrome” oder “Cookies deaktivieren Chrome” im Falle eines Chrome Browsers.</p>

<p className="h3">Rechtsgrundlage</p>
...
<p className="small">Alle Texte sind urheberrechtlich geschützt.</p>
<p className="small">Quelle: Erstellt mit dem Datenschutz Generator von AdSimple</p>
