...
function Impressum() {
  ...
  return (
    <div className='content text-color-main'>
        ...
        <p><strong class="h3 underline">EU-Streitschlichtung</strong></p>
        ...
        <p class="h3">Haftung für Inhalte dieser Website</p>
        ...
        <p class="h3">Haftung für Links auf dieser Website</p>
        ...
        <p class="h3">Urheberrechtshinweis</p>
        ...
        <p class="h3">Datenschutzerklärung</p>

        <p class="h4">Inhaltsverzeichnis</p>

        <p class="h5">Einleitung und Überblick</p>
        ...
        <p class="h5">Anwendungsbereich</p>
        ...
        <p class="h5">Kontaktdaten des Verantwortlichen</p>
        ...
        <p class="h2">Rechte laut Datenschutz-Grundverordnung</p>
...
<p class="h3">HTTP Cookie Interaktion zwischen Browser und Webserver</p>
...
<p class="h3">Welche Arten von Cookies gibt es?</p>
...
<p class="h3">Zweck der Verarbeitung über Cookies</p>
...
<p class="h3">Welche Daten werden verarbeitet?</p>
...
<p class="small">Alle Texte sind urheberrechtlich geschützt.</p>
<p class="small">Quelle: Erstellt mit dem Datenschutz Generator von AdSimple</p>
